...
public class SignatureModel extends Model {
    ...
    public void setMoccaSignatureAlgorithm(String moccaSignatureAlgorithm) {
        final String oldValue = this.moccaSignatureAlgorithm;
        final String newValue = moccaSignatureAlgorithm;
        this.moccaSignatureAlgorithm = newValue;
        firePropertyChange(PROPERTY_MOCCA_SIGNATURE_ALGORITHM, oldValue, newValue);
    }
