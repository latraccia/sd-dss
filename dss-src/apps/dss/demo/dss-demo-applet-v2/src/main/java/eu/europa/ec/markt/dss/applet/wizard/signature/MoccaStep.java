 ...
 */
public class MoccaStep extends WizardStep<SignatureModel, SignatureWizardController> {
    /**
     * 
     * The default constructor for MoccaStep.
     * 
     * @param model
     * @param view
     * @param controller
     */
    public MoccaStep(SignatureModel model, WizardView<SignatureModel, SignatureWizardController> view, SignatureWizardController controller) {
