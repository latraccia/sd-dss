		...
		<div class="table-container">
			<table class="data-table">
				...
				<tbody>
					...
					<tr>
						<td><a href="<spring:url value="/admin/proxy/edit?key=${preference.key}"/>"><spring:message code="${preference.key}"/></a></td>
						<td><a href="<spring:url value="/admin/proxy/edit?key=${preference.key}"/>">${preference.value}</a></td>
					</tr>
					</c:forEach>
				</tbody>
			</table>		
