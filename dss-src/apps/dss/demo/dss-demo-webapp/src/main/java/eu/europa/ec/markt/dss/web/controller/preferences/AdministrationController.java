...
public class AdministrationController {
    /**
     * @see ReloadableTrustedListCertificateSource
     */
    @Autowired
    private ReloadableTrustedListCertificateSource trustListCertificateSource;
    /**
    ...
    public String showSignature(final Model model) {
        model.addAttribute("certs", trustListCertificateSource.getCertificates());
        model.addAttribute("tsls", trustListCertificateSource.getDiagnosticInfo().entrySet());
