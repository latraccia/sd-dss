 ...
 * 
 * 
 * @version $Revision: 2467 $ - $Date: 2013-08-29 08:08:33 +0200 (jeu., 29 août 2013) $
 */
...
abstract class TrustServiceListFactory {
   ...
   public static TrustStatusList newInstance(Document tslDocument) throws IOException {
      ...
      try {
         Unmarshaller unmarshaller = getUnmarshaller();
         JAXBElement<TrustStatusListType> jaxbElement = (JAXBElement<TrustStatusListType>) unmarshaller.unmarshal(tslDocument);
         trustServiceStatusList = jaxbElement.getValue();
      } catch (JAXBException e) {
         throw new IOException("TSL parse error: " + e.getMessage(), e);
      }
   ...
   private static Unmarshaller getUnmarshaller() throws JAXBException {
      JAXBContext jaxbContext = JAXBContext.newInstance(eu.europa.ec.markt.tsl.jaxb.tsl.ObjectFactory.class, eu.europa.ec.markt.tsl.jaxb.tslx.ObjectFactory.class,
