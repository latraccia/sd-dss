...
import eu.europa.ec.markt.dss.signature.pdf.itext.ITextPdfObjFactory;
...
public abstract class PdfObjFactory {
   ...
   private static final Logger LOGGER = Logger.getLogger(PdfObjFactory.class.getName());
      ...
      if (INSTANCE == null) {
         ...
         if (factoryClassName != null) {
            ...
            try {
               ...
               LOGGER.severe("dss.pdf_obj_factory is '" + factoryClassName + "' but factory cannot be instantiated (fallback will be used)");
            }
         }
         if (INSTANCE == null) {
            LOGGER.info("Fallback to '" + ITextPdfObjFactory.class.getName() + "' as the PDF Object Factory Implementation");
            INSTANCE = new ITextPdfObjFactory();
         }
      }
      return INSTANCE;
   }
   ...
   public abstract PDFSignatureService newTimestampSignatureService();
