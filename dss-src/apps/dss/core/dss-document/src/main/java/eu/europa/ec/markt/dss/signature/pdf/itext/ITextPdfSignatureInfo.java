...
class ITextPdfSignatureInfo implements PdfSignatureInfo {

	private PdfPKCS7 wrapped;

	ITextPdfSignatureInfo(PdfPKCS7 wrapped) {
	...
	public Date getSigningDate() {
		if (wrapped.getSignDate() != null) {
			return wrapped.getSignDate().getTime();
		} else {
			return null;
		}
	}
