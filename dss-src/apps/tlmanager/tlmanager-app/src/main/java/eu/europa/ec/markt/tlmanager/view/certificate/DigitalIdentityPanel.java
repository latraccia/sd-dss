...
public class DigitalIdentityPanel extends JPanel implements ContentDialogCloser {

    private static final Logger LOG = Logger.getLogger(DigitalIdentityPanel.class.getName());
     ...
     */
    public DigitalIdentityPanel(JFileChooser fileChooser) {
    ...
    private void loadCertificate(File file) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, message,
                    uiKeys.getString("DigitalIdentityPanel.error.title"), JOptionPane.INFORMATION_MESSAGE);
        ...
        if (digitalIdentityModel != null) {
            ...
            if (certificate != null) {
                if (certificate.getSubjectX500Principal() != null) {
                    info = certificate.getSubjectX500Principal().getName(X500Principal.RFC2253);
                } else {
